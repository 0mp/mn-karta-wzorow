...
% Uwarunkowanie. Opcjonalny argument służy do podania ewentualnego określenia,
% czy mowa o uwarunkowaniu względnym, czy bezwzględnym.
% Na przykład: $\cond[abs](A)$.
\newcommand{\cond}[2][]{\mathrm{cond}_{\mathrm{#1}}(#2)}
